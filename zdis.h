...
struct zdis_ctx {
  ...
  /// Target address the program is designed to load at, used for printing address
  /// and calculation of absolute address for relative & vice versa
  uint32_t zdis_target_addr;
